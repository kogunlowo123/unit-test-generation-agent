"""Unit Test Generation Agent - Main Agent Implementation."""
...
class UnitTestGenerationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.test_generation_enabled = True
        self.mock_generation_enabled = True
        self.edge_case_discovery_enabled = True
        self.mutation_testing_enabled = True
        self.coverage_analysis_enabled = True
        self._tool_dispatch = {
            "generate_unit_tests": self.tools.generate_unit_tests,
            "generate_mocks": self.tools.generate_mocks,
            "find_edge_cases": self.tools.find_edge_cases,
            "run_mutation_testing": self.tools.run_mutation_testing,
            "analyze_coverage_gaps": self.tools.analyze_coverage_gaps,
            "generate_property_tests": self.tools.generate_property_tests,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['test_generation', 'mock_generation', 'edge_case_discovery', 'mutation_testing', 'coverage_analysis'],
        )
